...
public class FunctionScanner extends RuleBasedScanner {
	...
	public FunctionScanner( ColorManager manager) {
		IToken defaultToken = 
				new Token(
						new TextAttribute(
		...
		IToken optionalParameterToken = new Token(new TextAttribute(manager.getColor(IColorConstants.DEFAULT),null,SWT.ITALIC));
		IToken regexToken = new Token(new TextAttribute(manager.getColor(IColorConstants.DEFAULT),null,SWT.BOLD));
